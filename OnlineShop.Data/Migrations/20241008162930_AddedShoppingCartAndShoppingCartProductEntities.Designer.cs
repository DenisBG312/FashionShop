...
namespace OnlineShop.Web.Data.Migrations
{
    ...
    [Migration("20241008162930_AddedShoppingCartAndShoppingCartProductEntities")]
    partial class AddedShoppingCartAndShoppingCartProductEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OnlineShop.Data.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            OrderDate = new DateTime(2024, 10, 8, 19, 29, 29, 752, DateTimeKind.Local).AddTicks(7641),
                            TotalAmount = 150.00m,
                            UserId = "1bcd7ed2-50a3-44b6-b5ec-9ebcc7494376"
                        },
                        new
                        {
                            Id = 2,
                            OrderDate = new DateTime(2024, 10, 7, 19, 29, 29, 752, DateTimeKind.Local).AddTicks(7649),
                            TotalAmount = 75.50m,
                            UserId = "1bcd7ed2-50a3-44b6-b5ec-9ebcc7494376"
                        });
                });
            ...
            modelBuilder.Entity("OnlineShop.Data.Models.ShoppingCart", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amount = 1575.00m,
                            PaymentDate = new DateTime(2024, 10, 8, 19, 29, 29, 753, DateTimeKind.Local).AddTicks(3580),
                            Status = "Active",
                            UserId = "1bcd7ed2-50a3-44b6-b5ec-9ebcc7494376"
                        });
                });
